...
#
# Resolves git merge conflicts on a given PR branch by merging master,
# using OpenCode CLI to auto-fix conflicts, running lint & tests, and
# pushing the resolved branch. Re-enables auto-merge on success.
#
